...
export default class Colledge {
    ...
    getStatHours(interval) {
        return this.#getStat(interval, 'hours')
    }

    getStatCost(interval) {
        return this.#getStat(interval, 'cost')
    }

    #getStat(interval, key){
        return _.countBy(this.getAllCourses(), course => Math.floor(course[key]/interval))
    }
